...
import FindPwd4 from "./FindPwd4";
import Button from "./Button";

export default class FindPwd3 extends Component {
    // 构造
    constructor(props) {
        super(props);
        // 初始状态
    ...
    render() {
        return (
            ...
            <View style={{flex: 1, }}>
                <HeadView nv={this.props.nv} text="找回密码3" onBackClick={this._onBack}/>
                <View style={{flexDirection: 'row'}}>
                    ...
                    <View style={{flex: 1, flexDirection: 'column',margin:utils.dp2px(94),}}>
                        ...
                        <View style={{marginTop:BaseStyles._base_btn_dx_height}}>
                            <Button btntext="下一步" onBtnClick={this._toPwd4} btnHeight={48}
