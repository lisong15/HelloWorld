    ...
    _onClicked = () => {
        ...
        if (aa) {
            requestAnimationFrame(() => {
                aa(!this.state.opened && this.state.rightHintText, !this.state.isHead && this.state.leftHintText, this._changedText, id);
        ...
        return (<TouchableOpacity onPress={this._onClicked}
            ...
            <View
                ...
                <View
                    ...
                    <Text
                        style={{fontSize:bStyles._base_ctext_px_size,color: '#000'}}>{isNeedChanged ? abc : this.state.rightHintText}</Text>}
