...
(function (webim) {
                                ...
                                if (resp.JoinedStatus && resp.JoinedStatus == 'JoinedSuccess') {
                                    if (resp.LongPollingKey) {
                                        ...
                                        cbErr && cbErr(tool.getReturnError(
                                            "The type of group is not AVChatRoom: groupid=" + options.GroupId));
                                        return;
                                    }
                                }
                                if (cbOk) {
    ...
    var MsgManager = new function () {
        ...
        //初始化
        this.init =
            function (onMsgNotify, onBigGroupMsgNotify, onGroupSystemNotifys, onGroupInfoChangeNotify, cbOk, cbErr) {
                if (!onMsgNotify) {
